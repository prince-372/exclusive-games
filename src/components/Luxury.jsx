  ...
  return (
    <div>
      <div className="bg-[#00141B]">
        <div className="max-w-[1140px] mx-auto px-3 py-12">
          <div
            className={`  max-w-[1140px] bg-sec7bg relative bg-no-repeat bg-cover bg-center border-[0.5px] border-solid border-[#FFFFFF80] bg-[#062023]`}
          >
            ...
            <div className=" absolute max-sm:hidden top-[100px] right-[28px] md:right-[10%] md:top-[16%] animate-pulse duration-300  lg:right-[12%] l:top-[16%]">
              <img
                src={paanA}
                alt="paanA"
                className="lg:w-[176px] lg:h-[186px] w-[100px]"
              />
            </div>
            <div className=" animate-pulse duration-300 absolute max-sm:hidden top-[100px] left-[28px] md:left-[10%] md:top-[16%   lg:left-[12%] lg:top-[16%]">
              <img
                src={greebcoian}
                alt="greebcoian"
                className="w-[60px] lg:w-[78] lg-h-[79px] "
              />
            </div>
            ...
            <h2 className="text-[32px] mt-[46px] text-white font-normal leading-[41.6px]  font-Anton text-center">
              Luxury
            </h2>
            <p className="text-[16px] pt-[16px] text-[#CDD4D5] leading-[35.6px] font-medium max-w-[391px] text-center m-auto">
            ...
            <h2 className="text-[48px] pt-[32px] mb-[16px] text-white leading-[57.6px] font-normal text-center font-Anton">
              $9000
            </h2>
            <div className="flex flex-cnol justify-center items-center">
              <div className="mt-1">
                <span className="flex text-center gap-[8px] items-center">
                  <Correct />
                  <p className="text-[16px] text-[#CDD2D3]  font-Inter font-medium max-w-[387px]">
                ...
                <span className="flex gap-[8px]  mt-[12px] items-center">
                  <Correct />
                  <p className="text-[16px] text-[#CDD2D3] font-Inter text-center m-auto font-medium max-w-[387px]">
                    Control de RTP (controlás qué porcentaje pagar)
                  </p>
                </span>
                <span className="flex text-center gap-[8px]  mt-[12px] items-center">
                  <Correct />
                  <p className="text-[16px] text-[#CDD2D3]  font-Inter font-medium text-center  m-auto max-w-[387px]">
                ...
                <span className="flex text-center gap-[8px]  mt-[12px] items-center">
                  <Correct />
                  <p className="text-[16px] text-[#CDD2D3] font-Inter font-medium m-auto max-w-[387px]">
                ...
                <span className="flex  text-center gap-[8px]  mt-[12px] max-w-[419px] items-center">
                  ...
                  <p className="text-[16px] text-[#CDD2D3] font-Inter font-medium text-center m-auto leading-[25.6px]">
