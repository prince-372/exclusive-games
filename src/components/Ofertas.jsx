...
import casino from "../assets/image/board-casino.png";
import { ButtonBottom, Correct } from "./Icones";
import Primarybtn from "./Primarybtn";
import boxshadow from "../assets/image/boxshadow.png";
    ...
    <div>
      <div className="bg-[#00141B]">
        <div className="max-w-[1140px] mx-auto px-3">
          <h2 className="text-[48px] text-white leading-[57.6px] font-Anton font-normal text-center pt-[150px]">
            Nuestras ofertas
          </h2>
          <p className="text-[16px] font-medium font-Inter text-white leading-[25.6px] text-center mb-[60px]">
            ...
            <div className="grid lg:grid-cols-2 px-3 mt-[57px]">
              <div className=" col-span-1 flex justify-center">
                <div className=" relative">
                  <img src={casino} alt="boxshadow" className="mt-[30px]" />
                  <img
                    className=" mix-blend-multiply absolute bottom-[26%]"
                    src={boxshadow}
                    alt="boxshadow"
                  />
                </div>
              </div>
              <div className=" col-span-1 flex flex-col justify-center mt-6 items-center lg:items-start">
                <h2 className="text-[32px] text-white font-normal leading-[41.6px] font-Anton">
                  Silver
                </h2>
                <p className="text-[16px] text-[#CDD2D3] font-Inter font-medium max-w-[401px] pb-[32px] pt-[16px]">
                  Diseño predeterminado, atractivo y fácil de navegar,
                  tecnología HTLM5.
                </p>
                <h2 className="text-[48px] text-white font-normal font-Anton leading-[57.6px]">
                  $5000
                </h2>
                <div>
                  <div>
                    <span className="flex gap-[8px] pb-[12px] items-center pt-[16px]">
                      <Correct />
                      <p className="text-[16px] text-[#CDD2D3] font-Inter font-medium max-w-[401px]">
