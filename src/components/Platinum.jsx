                    ...
                    <div className='bg-[#062024] border-[0.5px] border-solid border-[#FFFFFF80] relative z-[1] overflow-hidden'>
                        ...
                        <div className='grid lg:grid-cols-2  mt-[78px] mb-[78px] '>
                            ...
                            <div className=' col-span-1 ps-[50px] px-3'>
                                <h2 className='text-[32px] mt-[43px]  text-white leading-[41.6px] font-Anton font-normal ' >Platinum</h2>
                                <p className='text-[16px] mt-[16px] text-[#CDD2D3] font-medium font-Inter leading-[25.6px] max-w-[364px] '>Diseño totalmente personalizado. Contáctanos para un presupuesto.</p>
                                <h2 className='text-[48px] mt-[32px] text-white leading-[57.6px] font-normal font-Anton'>Consultar precio</h2>
